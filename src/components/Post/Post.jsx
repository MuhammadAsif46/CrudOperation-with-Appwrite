  ...
  return (
    <div className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
      <div className="flex flex-col gap-2 items-end px-4 pt-4 relative">
        ...
        <div
          id="dropdown"
          className={`absolute top-14 right-1 z-10 ${dropdownOpen ? 'block' : 'hidden'} text-start text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700`}
        >
      ...
      <div className="flex flex-col items-center pb-10">
        <h5 className="mb-1 text-xl text-center px-10 font-medium text-gray-900 dark:text-white">
          Bonnie Green hello world salam user hello i am inter value from english and urdu
        </h5>
